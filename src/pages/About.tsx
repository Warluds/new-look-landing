import { ArrowLeft, Building2, CalendarDays, CheckCircle2, GraduationCap, Palette, Users } from "lucide-react";
import { Link } from "react-router-dom";
import heroImage from "@/assets/abis-showroom-hero.jpg";
import image2010 from "@/assets/about/history/abis-2010.png";
import image2011 from "@/assets/about/history/abis-2011.png";
import image2012 from "@/assets/about/history/abis-2012.png";
import image2013 from "@/assets/about/history/abis-2013.png";
import image2014 from "@/assets/about/history/abis-2014.png";
import image2015 from "@/assets/about/history/abis-2015.png";
import image2016 from "@/assets/about/history/abis-2016.png";
import image2017 from "@/assets/about/history/abis-2017.png";
import image2018 from "@/assets/about/history/abis-2018.png";
import image2019 from "@/assets/about/history/abis-2019.png";
import image2020 from "@/assets/about/history/abis-2020.png";
import image2021 from "@/assets/about/history/abis-2021.png";
import image2022 from "@/assets/about/history/abis-2022.jpg";
import image2023 from "@/assets/about/history/abis-2023.jpg";
import image2024 from "@/assets/about/history/abis-2024.jpg";
import image2025 from "@/assets/about/history/abis-2025.jpg";
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-12 space-y-6">
            {history.map((item, index) => (
              <article key={item.year} className="grid overflow-hidden rounded-2xl border border-hero-foreground/14 bg-hero-foreground/8 shadow-luxe backdrop-blur-md lg:grid-cols-[0.78fr_1fr]">
                <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                  <img src={item.image} alt={`${item.year}: ${item.title}, фото магазина или шоурума ABIS Group`} className="h-72 w-full object-cover lg:h-full" loading="lazy" />
                </div>
