...
const T = {
  ...
  stats: [
    [["16 лет", "16 жыл", "16 years"], ["опыта импорта", "импорт тәжірибесі", "of import expertise"]],
    [["50+", "50+", "50+"], ["брендов в портфеле", "портфельдегі брендтер", "brands in portfolio"]],
    [["2 300 м²", "2 300 м²", "2,365 m²"], ["складская инфраструктура", "қойма инфрақұрылымы", "warehouse infrastructure"]],
  ] as Array<[Tr, Tr]>,
};
...
const services: Array<{ icon: typeof Globe2; title: Tr; text: Tr }> = [
  ...
  },
  {
    ...
    text: [
      "Собственные складские мощности 2 300 м² с учётом, упаковкой и распределением.",
      "Меншікті қойма қуаттары 2 300 м² — есеп, орау және тарату.",
