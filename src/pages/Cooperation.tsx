...
const advantages: Array<{ icon: typeof PackageCheck; title: Tr; text: Tr }> = [
  ...
  {
    icon: Palette,
    title: ["110 000+ оттенков", "110 000+ реңк", "110,000+ tints"],
    text: [
...
const bigStats: Array<[Tr, Tr]> = [
  ...
  [["110 000+", "110 000+", "110,000+"], ["оттенков колеровки", "колеровка реңктері", "tint shades"]],
  [["500+", "500+", "500+"], ["партнёров и дилеров", "серіктестер мен дилерлер", "partners and dealers"]],
];
